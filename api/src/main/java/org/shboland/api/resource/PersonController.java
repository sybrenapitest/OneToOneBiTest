...
public class PersonController implements IPersonController {
    ...
    @Override
    public ResponseEntity deleteDetailsWithPerson(@PathVariable long personId, @PathVariable long detailsId) {

        return personService.removeDetails(personId, detailsId) ?
                ResponseEntity.ok().build() :
                ResponseEntity.notFound().build();
    }

    @Override
    public ResponseEntity putDetailsWithPerson(@PathVariable long personId, @PathVariable long detailsId) {

        return personService.updatePersonWithDetails(personId, detailsId) ?
                ResponseEntity.ok().build() :
                ResponseEntity.notFound().build();
    }
