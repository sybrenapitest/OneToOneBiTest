...
public interface IPersonController {
    ...
    @RequestMapping(value = "/{personId}/detailss/{detailsId}", method = RequestMethod.DELETE)
    ResponseEntity deleteDetailsWithPerson(@PathVariable("personId") long personId, @PathVariable("detailsId") long detailsId);

    @RequestMapping(value = "/{personId}/detailss/{detailsId}", method = RequestMethod.PUT)
    ResponseEntity putDetailsWithPerson(@PathVariable("personId") long personId, @PathVariable("detailsId") long detailsId);
