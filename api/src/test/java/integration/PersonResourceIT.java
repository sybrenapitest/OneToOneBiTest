...
public class PersonResourceIT {
    ...
    public void testGetDetailss_withPersonWithDetailss() throws Exception {
        ...
        Person person = IntegrationTestFactory.givenAPersonWithDetails(personRepository, detailsRepository);
    ...
    @Test
    public void testDeleteDetails_withPersonWithDetailss() throws Exception {
    
        Person person = IntegrationTestFactory.givenAPersonWithDetails(personRepository, detailsRepository);
        Details details = new ArrayList<>(person.getDetailsSet()).get(0);

        MockHttpServletResponse response =
                mockMvc.perform(MockMvcRequestBuilders.delete("/persons/" + person.getId() + "/detailss/" + details.getId()))
                        .andReturn().getResponse();
        ...
        assertFalse("Wrong entity link returned.",
                mockMvc.perform(MockMvcRequestBuilders.get("/persons/" + person.getId() + "/detailss"))
                        ...
                        .contains("/detailss/" + details.getId()));
    }

    @Test
    public void testDeleteDetails_withPersonNoDetailss() throws Exception {
    
        Person person = IntegrationTestFactory.givenAPerson(personRepository);

        MockHttpServletResponse response =
                mockMvc.perform(MockMvcRequestBuilders.delete("/persons/" + person.getId() + "/detailss/-1"))
                        .andReturn().getResponse();
    ...
    @Test
    public void testDeleteDetails_withoutPerson() throws Exception {
    
        MockHttpServletResponse response =
                mockMvc.perform(MockMvcRequestBuilders.delete("persons/-1/detailss/-1"))
                        .andReturn().getResponse();
    ...
    @Test
    public void testPutDetails_withPerson() throws Exception {

        Person person = IntegrationTestFactory.givenAPerson(personRepository);
        Details details = IntegrationTestFactory.givenADetails(detailsRepository);

        MockHttpServletResponse response =
                mockMvc.perform(MockMvcRequestBuilders.put("/persons/" + person.getId() + "/detailss/" + details.getId()))
                        .andReturn().getResponse();
    ...
    @Test
    public void testPutDetails_withPersonWithDetails() throws Exception {
    ...
    @Test
    public void testPutDetails_withPersonNoDetails() throws Exception {
    
        Person person = IntegrationTestFactory.givenAPerson(personRepository);

        MockHttpServletResponse response =
                mockMvc.perform(MockMvcRequestBuilders.put("/persons/" + person.getId() + "/detailss/-1"))
                        .andReturn().getResponse();
    ...
    @Test
    public void testPutDetails_withoutPerson() throws Exception {
    
        MockHttpServletResponse response =
                mockMvc.perform(MockMvcRequestBuilders.put("/persons/-1/detailss/-1"))
                        .andReturn().getResponse();
