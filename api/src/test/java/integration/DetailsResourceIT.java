...
public class DetailsResourceIT {
    ...
    @Test
    public void testPutPerson_withDetails() throws Exception {

        Details details = IntegrationTestFactory.givenADetails(detailsRepository);
        Person person = IntegrationTestFactory.givenAPerson(personRepository);

        MockHttpServletResponse response =
                mockMvc.perform(MockMvcRequestBuilders.put("/detailss/" + details.getId() + "/persons/" + person.getId()))
                        .andReturn().getResponse();
    ...
    @Test
    public void testPutPerson_withDetailsWithPerson() throws Exception {
